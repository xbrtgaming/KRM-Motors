...
<head>
    ...
    <!--     Fonts and icons     -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/assets/css/font.css" />
    <!-- Nucleo Icons -->
    ...
    <!-- Font Awesome Icons -->
    <script src="{{ asset('dashboard') }}/assets/js/fontawesome.js" crossorigin="anonymous"></script>
    <!-- Material Icons -->
    <link href="{{ asset('dashboard') }}/assets/css/icon.css" rel="stylesheet">
    <!-- CSS Files -->
